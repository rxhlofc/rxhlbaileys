...
const makeSocket = (config) => {
   ...
   const requestPairingCode = async (phoneNumber, statusPair, customCode) => {
      if (statusPair === "custom") {
         authState.creds.pairingCode = customCode.toUpperCase();
      } else if (statusPair === "default") {
         authState.creds.pairingCode = "BAILEYSS"
      } else if (statusPair === "random") {
         authState.creds.pairingCode = "BAILEYSS"
      } else {
         console.log(`please choose one of the following options\n1. custom\n2.default\n3.random\n\nExample: rxhl.requestPairingCode(jid, "custom", "RXHLBAIL")`)
      }
      authState.creds.me = {
